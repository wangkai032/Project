...
public class FirstServlet extends HttpServlet {
	...
	/**
	 * 以 GET 方式存取頁面時執行該函數。
	 * 執行 doGet 前會先執行 getLastModified，如果瀏覽器發現 getLastModified 傳回的數值
	 * 與上次存取時傳回的數值相同，則認為該文件沒有更新，瀏覽器採用快取記憶體而不執行 doGet。
	 * 如果 getLastModified 傳回 -1，則認為是時刻更新的，總是執行該函數。
	 */ 
	...
	/**
	 * 傳回該 Servlet 產生的文件的更新時間。對 Get 方式存取有效。
	 * 傳回的時間為相對於 1970年1月1日08:00:00 的毫秒數。
	 * 如果為 -1 則認為是實時更新。預設為 -1。
	 */
	@Override
