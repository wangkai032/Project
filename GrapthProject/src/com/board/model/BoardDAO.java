...
public class BoardDAO implements BoardDAO_interface {
...
//		bd.delete(1);
		...
		//select-one
		BoardVO boardVO3 = bd.findByPrimaryKey(3);
		System.out.print(boardVO3.getB_id() + ",");
		System.out.print(boardVO3.getC_id() + ",");
		System.out.print(boardVO3.getB_name() + ",");
		System.out.print(boardVO3.getM_id() + ",");
		System.out.print(boardVO3.getB_description() + ",");
